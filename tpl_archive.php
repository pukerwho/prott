...
<div class="container py-4">
  <div class="flex items-center justify-between mb-4">
    ...
    <div class="flex items-center gap-x-2">
      <div>
        <div class="relative inline-flex items-center px-4 py-1.5 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded-lg cursor-pointer">
          <a href="/pay" class="w-full h-full absolute top-0 left-0 z-1"></a>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-2"><path stroke-linecap="round" stroke-linejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9-4.414c.376.023.75.05 1.124.08 1.131.094 1.976 1.057 1.976 2.192V16.5A2.25 2.25 0 0 1 18 18.75h-2.25m-7.5-10.5H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V18.75m-7.5-10.5h6.375c.621 0 1.125.504 1.125 1.125v9.375m-8.25-3 1.5 1.5 3-3.75" /></svg>
          Архів
        </div>
      </div>
      <div>
    ...
    <div class="posts">
      <table class="w-full table-auto prott-table">
        <thead class="bg-[#eeeeee] font-semibold text-sm text-gray-700">
          <tr>
            <th class="text-left whitespace-nowrap px-1 py-2">
              <div class="text-left font-bold"><?php _e("ID", "treba-wp"); ?></div>
            </th>
            <th class="text-left whitespace-nowrap px-1 py-2" data-sort-id="1">
              <div class="text-left font-bold"><?php _e("Сайт", "treba-wp"); ?></div>
            </th>
            <th class="text-left whitespace-nowrap px-1 py-2" data-sort-id="2">
              <div class="text-left font-bold"><?php _e("Статус", "treba-wp"); ?></div>
            </th>
            <th class="text-left whitespace-nowrap px-1 py-2 prott-sort-js" data-sort-id="3">
            ...
            <th class="text-left whitespace-nowrap px-1 py-2" data-sort-id="4">
              <div class="text-left font-bold"><?php _e("Завдання", "treba-wp"); ?></div>
            </th>
            <th class="text-left whitespace-nowrap px-1 py-2 prott-sort-js" data-sort-id="5">
              <div class="flex items-center">
            ...
            <th class="text-center whitespace-nowrap px-1 py-2">
