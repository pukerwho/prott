      ...
      <thead class="text-sm border-b border-gray-200 text-gray-600">
        <tr>
          ...
          <th class="text-center whitespace-nowrap py-2">
            <div class="text-left font-bold"><?php _e("Сателіти", "treba-wp"); ?></div>
          </th>
        </tr>
      </thead>
      <tbody class="text-sm">
        ...
        ?>
          ...
          <tr class="border-b border-gray-200 last:border-transparent">
            ...
            <td class="whitespace-nowrap py-2"><div class="text-blue-500 satelite-click-js cursor-pointer" data-satelite-id="<?php echo $current_id; ?>">Детальніше</div></td>
          </tr>
