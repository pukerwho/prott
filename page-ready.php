        ...
        <tbody class="text-sm">
          ...
          <?php if ($tasks->have_posts()) : while ($tasks->have_posts()) : $tasks->the_post(); ?>
            ...
            <tr class="border-b border-gray-200 last:border-transparent">
              ...
              <td class="whitespace-nowrap py-2">
                <?php if ($get_status === 'Нове завдання'): ?>
                  <div class="task-accept flex items-center justify-center bg-blue-500 text-white rounded text-center cursor-pointer px-6 py-1 task-accept-js" data-post-id="<?php echo $current_id; ?>" data-author-accept="<?php echo get_the_author(); ?>">
                    <div class="mr-2">
